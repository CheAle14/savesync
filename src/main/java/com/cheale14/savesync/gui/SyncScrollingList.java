...
// Taken from mcforge GuiScrollingList.
// Needed to allow manual scrolling
public abstract class SyncScrollingList
{
    ...
    public SyncScrollingList(Minecraft client, int width, int height, int top, int bottom, int left, int entryHeight)
    {
       this(client, width, height, top, bottom, left, entryHeight, width, height);
    }
    public SyncScrollingList(Minecraft client, int width, int height, int top, int bottom, int left, int entryHeight, int screenWidth, int screenHeight)
    {
        this.client = client;
